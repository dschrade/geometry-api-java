...
public class Proximity2DResult {
    ...
    /**
     * Returns the closest coordinate for OperatorProximity2D.getNearestCoordinate
     * or the vertex coordinates for the OperatorProximity2D.getNearestVertex and
    ...
    /**
     * Returns the vertex index. For OperatorProximity2D.getNearestCoordinate the
     * behavior is: When the input is a polygon or an envelope and the
     * bTestPolygonInterior is true, the value is zero. When the input is a polygon
     * or an Envelope and the bTestPolygonInterior is false, the value is the start
     * vertex index of a segment with the closest coordinate. When the input is a
     * polyline, the value is the start vertex index of a segment with the closest
     * coordinate. When the input is a point, the value is 0. When the input is a
     * multipoint, the value is the closest vertex.
     */
