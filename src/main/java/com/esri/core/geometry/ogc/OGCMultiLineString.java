...
public class OGCMultiLineString extends OGCMultiCurve {
    ...
    public String asText() {
        return GeometryEngine.geometryToWkt(getEsriGeometry(), WktExportFlags.wktExportMultiLineString);
    }
    ...
    public ByteBuffer asBinary() {
        ...
        return op.execute(WkbExportFlags.wkbExportMultiLineString, getEsriGeometry(), null);
    }
