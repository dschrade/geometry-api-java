...
public class OGCPolygon extends OGCSurface {
    ...
    public String asText() {
        return GeometryEngine.geometryToWkt(getEsriGeometry(), WktExportFlags.wktExportPolygon);
    }
    ...
    public ByteBuffer asBinary() {
        ...
        return op.execute(WkbExportFlags.wkbExportPolygon, getEsriGeometry(), null);
    }
    ...
    public OGCLineString exteriorRing() {
        if (polygon.isEmpty())
            return new OGCLinearRing((Polygon) polygon.createInstance(), 0, esriSR, true);
    ...
    public OGCMultiCurve boundary() {
        ...
        return (OGCMultiCurve) OGCGeometry.createFromEsriGeometry(polyline, esriSR, true);
    }
