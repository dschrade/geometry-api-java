...
public class OGCLineString extends OGCCurve {
    ...
    public String asText() {
        return GeometryEngine.geometryToWkt(getEsriGeometry(), WktExportFlags.wktExportLineString);
    }
    ...
    public ByteBuffer asBinary() {
        ...
        return op.execute(WkbExportFlags.wkbExportLineString, getEsriGeometry(), null);
    }
    ...
    public OGCPoint pointN(int n) {
        ...
        return (OGCPoint) OGCGeometry.createFromEsriGeometry(multiPath.getPoint(nn), esriSR);
    }
