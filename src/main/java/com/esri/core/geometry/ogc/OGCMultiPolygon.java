...
public class OGCMultiPolygon extends OGCMultiSurface {
    ...
    public String asText() {
        return GeometryEngine.geometryToWkt(getEsriGeometry(), WktExportFlags.wktExportMultiPolygon);
    }
    ...
    public ByteBuffer asBinary() {
        ...
        return op.execute(WkbExportFlags.wkbExportMultiPolygon, getEsriGeometry(), null);
    }
