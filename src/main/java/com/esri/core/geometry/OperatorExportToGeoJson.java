...
public abstract class OperatorExportToGeoJson extends Operator {
     ...
     *            The SpatialReference of the Geometry. Will be written as
     *            "crs":null if the spatialReference is null.
     * @param geometryCursor
     *            The cursor of geometries to write as GeoJson.
     ...
     *            "crs":null if the spatialReference is null.
     * @param geometry
     *            The Geometry to write as GeoJson.
     ...
     * 
     * @param exportFlags
     *            Use the {@link GeoJsonExportFlags} interface.
     * @param spatialReference
     *            The SpatialReference of the Geometry. Will be written as
     *            "crs":null if the spatialReference is null.
     * @param geometry
     ...
     * reference or crs tag. Assumes the geometry is in wgs84.
     * 
     * @param geometry
     *            The Geometry to write as GeoJson.
     * @return Returns a string in GeoJson format.
