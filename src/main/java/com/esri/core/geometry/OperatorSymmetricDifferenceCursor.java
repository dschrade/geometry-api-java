...
class OperatorSymmetricDifferenceCursor extends GeometryCursor {
    ...
    OperatorSymmetricDifferenceCursor(GeometryCursor inputGeoms, GeometryCursor rightGeom, SpatialReference sr,
    ...
    public Geometry next() {
        ...
        if ((leftGeom = m_inputGeoms.next()) != null) {
            ...
            return OperatorSymmetricDifferenceLocal.symmetricDifference(leftGeom, m_rightGeom, m_spatial_reference,
                    m_progress_tracker);
        }
        return null;
    }
