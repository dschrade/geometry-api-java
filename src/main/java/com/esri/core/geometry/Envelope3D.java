...
public final class Envelope3D implements Serializable {
    ...
    public static Envelope3D construct(double _xmin, double _ymin, double _zmin, double _xmax, double _ymax,
            double _zmax) {
    ...
    public void normalize() {
        ...
        ymin = min;
        ymax = max;
        min = StrictMath.min(zmin, zmax);
        max = StrictMath.max(zmin, zmax);
        zmin = min;
        zmax = max;
    }
    ...
    public boolean isIntersecting(Envelope3D other) {
        return !isEmpty() && !other.isEmpty() && ((xmin <= other.xmin) ? xmax >= other.xmin : other.xmax >= xmin) && // check
                                                                                                                     // that
                                                                                                                     // x
                                                                                                                     // projections
                                                                                                                     // overlap
    ...
    public boolean equals(Object _other) {
        ...
        if (xmin != other.xmin || ymin != other.ymin || zmin != other.zmin || xmax != other.xmax || ymax != other.ymax
                || zmax != other.zmax)
            return false;
