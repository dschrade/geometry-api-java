...
public abstract class OperatorImportFromGeoJson extends Operator {
     ...
     */
    public abstract MapGeometry execute(int importFlags, Geometry.Type type, JsonReader jsonReader,
     ...
     */
    public abstract MapOGCStructure executeOGC(int import_flags, String geoJsonString,
            ProgressTracker progress_tracker);
