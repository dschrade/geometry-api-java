...
public abstract class OperatorExportToESRIShape extends Operator {
     ...
     * 
     * @param exportFlags
     *            Use the {@link ShapeExportFlags} interface.
     * @param geometry
     *            The Geometry being exported.
     * @return Returns a ByteBuffer object containing the Geometry in ESRIShape
     *         format.
     */
     ...
     *            The Geometry being exported.
     * @param shapeBuffer
     *            The ByteBuffer to contain the exported Geometry in ESRIShape
     *            format.
