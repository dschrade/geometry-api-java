...
public final class ListeningGeometryCursor extends GeometryCursor {
     ...
     * call immediately the tock() method on the GeometryCursor returned by the
     * OperatorUnion (or OperatorConvexHull with b_merge == true). Call next() on
     * the GeometryCursor returned by the OperatorUnion when done listening to
     * incoming geometries to finish the union operation.
     * 
     * @param geom
     *            The geometry to be pushed into the cursor.
     */
