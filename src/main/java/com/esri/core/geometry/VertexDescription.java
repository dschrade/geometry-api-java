...
public final class VertexDescription {
    ...
    /**
     * Returns the attribute count of this description. The value is always greater
     * or equal to 1. The first attribute is always a POSITION.
     */
    ...
    /**
     * Returns the number of the components of the given semantics. For example, it
     * returns 2 for the POSITION.
     * 
     * @param semantics
     *            The semantics of the attribute.
     */
     ...
     * @return The function returns false, only when this description does not have
     *         some of the attribute that src has.
     */
    ...
    /**
     * Returns default value for each ordinate of the vertex attribute with given
     * semantics.
     */
    ...
    /**
     * Checks if the given value is the default one. The simple equality test with
     * GetDefaultValue does not work due to the use of NaNs as default value for
     * some parameters.
     */
    ...
    /**
     * 
     * Returns an offset to the first ordinate of the given attribute. This method
     * is used for the cases when one wants to have a packed array of ordinates of
     * all attributes, i.e.: X, Y, Z, ID, TEXTURE2D.u, TEXTURE2D.v
     */
    ...
    static final double[] _defaultValues = {0, 0, NumberUtils.NaN(), 0, 0, 0, 0, 0, 0};

    static final int[] _interpolation = {Interpolation.LINEAR, Interpolation.LINEAR, Interpolation.LINEAR,
            Interpolation.NONE, Interpolation.ANGULAR, Interpolation.LINEAR, Interpolation.LINEAR, Interpolation.LINEAR,
            Interpolation.NONE,};

    static final int[] _persistence = {Persistence.enumDouble, Persistence.enumDouble, Persistence.enumDouble,
            Persistence.enumInt32, Persistence.enumFloat, Persistence.enumFloat, Persistence.enumFloat,
