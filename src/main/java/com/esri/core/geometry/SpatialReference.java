...
/**
 * A class that represents the spatial reference for the geometry. This class
 * provide tolerance value for the topological and relational operations.
 */
public abstract class SpatialReference implements Serializable {
    ...
    /**
     * Creates an instance of the spatial reference based on the provided well known
     * ID for the horizontal coordinate system.
     * 
     * @param wkid
     *            The well-known ID.
    ...
    /**
     * Creates an instance of the spatial reference based on the provided well known
     * text representation for the horizontal coordinate system.
     * 
     * @param wktext
     *            The well-known text string representation of spatial reference.
     * @return SpatialReference The spatial reference.
     */
    ...
    /**
     * Returns the well known ID for the horizontal coordinate system of the spatial
     * reference.
     * 
    ...
    /**
     * Returns the oldest value of the well known ID for the horizontal coordinate
     * system of the spatial reference. This ID is used for JSON serialization. Not
     * public.
     */
    abstract int getOldID();

    /**
     * Returns the latest value of the well known ID for the horizontal coordinate
     * system of the spatial reference. This ID is used for JSON serialization. Not
     * public.
     */
     ...
     * 
     * When two points have xy coordinates closer than the tolerance value, they are
     * considered equal. As well as when a point is within tolerance from the line,
     * the point is assumed to be on the line.
     * 
     * During topological operations the tolerance is increased by a factor of about
     * 1.41 and any two points within that distance are snapped together.
     * 
     ...
     * and content of the returned string is not part of the contract of the method
     * and is subject to change in any future release or patch without further
     * notice.
     */
