...
class OperatorDifferenceCursor extends GeometryCursor {
    ...
    OperatorDifferenceCursor(GeometryCursor inputGeoms, GeometryCursor geomSubtractor, SpatialReference sr,
    ...
    public Geometry next() {
        ...
        if ((geom = m_inputGeoms.next()) != null) {
            ...
            return OperatorDifferenceLocal.difference(geom, m_geomSubtractor, m_Spatial_reference, m_progress_tracker);
        }
        return null;
    }
