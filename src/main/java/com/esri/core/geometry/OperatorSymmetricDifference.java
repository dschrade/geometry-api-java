...
public abstract class OperatorSymmetricDifference extends Operator implements CombineOperator {
     ...
     *            is the set of Geometry instances to be XOR'd by rightGeometry.
     * @param rightGeometry
     *            is the Geometry being XOR'd with the inputGeometies.
     * @return Returns the result of the symmetric difference.
     *
     *         The operator XOR's every geometry in inputGeometries with
     *         rightGeometry.
     */
    public abstract GeometryCursor execute(GeometryCursor inputGeometries, GeometryCursor rightGeometry,
     ...
     * @return Returns the result of the symmetric difference.
     */
    public abstract Geometry execute(Geometry leftGeometry, Geometry rightGeometry, SpatialReference sr,
            ProgressTracker progressTracker);

    public static OperatorSymmetricDifference local() {
        return (OperatorSymmetricDifference) OperatorFactoryLocal.getInstance().getOperator(Type.SymmetricDifference);
    }
