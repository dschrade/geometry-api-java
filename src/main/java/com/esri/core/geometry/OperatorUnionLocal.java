...
class OperatorUnionLocal extends OperatorUnion {
    ...
    @Override
    public GeometryCursor execute(GeometryCursor inputGeometries, SpatialReference sr,
    ...
    public Geometry execute(Geometry geom1, Geometry geom2, SpatialReference sr, ProgressTracker progressTracker) {
        ...
        SimpleGeometryCursor inputGeometries = new SimpleGeometryCursor(geomArray);
