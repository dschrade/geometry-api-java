...
class OperatorExportToJsonCursor extends JsonCursor {
    ...
    static String exportToString(Geometry geometry, SpatialReference spatialReference,
    ...
    private static void exportToJson_(Geometry geometry, SpatialReference spatialReference, JsonWriter jsonWriter,
            Map<String, Object> exportProperties) {
        try {
    ...
    private static void exportPolygonToJson(Polygon pp, SpatialReference spatialReference, JsonWriter jsonWriter,
            Map<String, Object> exportProperties) {
        exportPolypathToJson(pp, "rings", spatialReference, jsonWriter, exportProperties);
    }

    private static void exportPolylineToJson(Polyline pp, SpatialReference spatialReference, JsonWriter jsonWriter,
            Map<String, Object> exportProperties) {
        exportPolypathToJson(pp, "paths", spatialReference, jsonWriter, exportProperties);
    }

    private static void exportPolypathToJson(MultiPath pp, String name, SpatialReference spatialReference,
            JsonWriter jsonWriter, Map<String, Object> exportProperties) {
        ...
        if (!pp.isEmpty()) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                if (bClosed && (startx != pt.x || starty != pt.y
                        || (bExportZs && !(NumberUtils.isNaN(startz) && NumberUtils.isNaN(z)) && startz != z)
                        || (bExportMs && !(NumberUtils.isNaN(startm) && NumberUtils.isNaN(m)) && startm != m))) {
    ...
    private static void exportMultiPointToJson(MultiPoint mpt, SpatialReference spatialReference, JsonWriter jsonWriter,
            Map<String, Object> exportProperties) {
    ...
    private static void exportPointToJson(Point pt, SpatialReference spatialReference, JsonWriter jsonWriter,
            Map<String, Object> exportProperties) {
    ...
    private static void exportEnvelopeToJson(Envelope env, SpatialReference spatialReference, JsonWriter jsonWriter,
            Map<String, Object> exportProperties) {
