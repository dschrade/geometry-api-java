...
public abstract class OperatorDifference extends Operator implements CombineOperator {
     ...
     *         inputGeometries.
     */
    public abstract GeometryCursor execute(GeometryCursor inputGeometries, GeometryCursor subtractor,
     ...
     */
    public abstract Geometry execute(Geometry inputGeometry, Geometry subtractor, SpatialReference sr,
            ProgressTracker progressTracker);

    public static OperatorDifference local() {
        return (OperatorDifference) OperatorFactoryLocal.getInstance().getOperator(Type.Difference);
    }
