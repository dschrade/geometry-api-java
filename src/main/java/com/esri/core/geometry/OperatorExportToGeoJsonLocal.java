...
class OperatorExportToGeoJsonLocal extends OperatorExportToGeoJson {
    ...
    public JsonCursor execute(SpatialReference spatialReference, GeometryCursor geometryCursor) {
        return new OperatorExportToGeoJsonCursor(GeoJsonExportFlags.geoJsonExportDefaults, spatialReference,
                geometryCursor);
    }

    @Override
    public String execute(SpatialReference spatialReference, Geometry geometry) {
        return OperatorExportToGeoJsonCursor.exportToGeoJson(GeoJsonExportFlags.geoJsonExportDefaults, geometry,
                spatialReference);
    }
