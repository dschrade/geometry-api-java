...
public class QuadTree implements Serializable {
    ...
    public static final class QuadTreeIterator {
        /**
         * Resets the iterator to an starting state on the QuadTree. If the input
         * Geometry is a Line segment, then the query will be the segment. Otherwise the
         * query will be the Envelope2D bounding the Geometry. \param query The Geometry
         * used for the query. \param tolerance The tolerance used for the intersection
         * tests.
         */
        ...
        /**
         * Resets the iterator to a starting state on the QuadTree using the input
         * Envelope2D as the query. \param query The Envelope2D used for the query.
    ...
    /**
     * Creates a QuadTree with the root having the extent of the input Envelope2D,
     * and height of the input height, where the root starts at height 0. \param
     * extent The extent of the QuadTree. \param height The max height of the
     * QuadTree.
     */
     ...
     * Creates a QuadTree with the root having the extent of the input Envelope2D,
     * and height of the input height, where the root starts at height 0. \param
     * extent The extent of the QuadTreeImpl. \param height The max height of the
     * QuadTreeImpl. \param bStoreDuplicates Put true to place elements deeper into
     * the quad tree at intesecting quads, duplicates will be stored. Put false to
     * only place elements into quads that can contain it..
     */
    ...
    /**
     * Inserts the element and bounding_box into the QuadTree. Note that a copy will
     * me made of the input bounding_box. Note that this will invalidate any active
     * iterator on the QuadTree. Returns an Element_handle corresponding to the
     * element and bounding_box. \param element The element of the Geometry to be
     * inserted. \param bounding_box The bounding_box of the Geometry to be
     * inserted.
     */
     ...
     * quad_handle. Note that a copy will me made of the input bounding_box. Note
     * that this will invalidate any active iterator on the QuadTree. Returns an
     ...
     * bounding_box of the Geometry to be inserted. \param hint_index A handle used
     * as a hint where to place the element. This can be a handle obtained from a
     * previous insertion and is useful on data having strong locality such as
     ...
     * this will invalidate any active iterator on the QuadTree. \param
     ...
     * \param query The Envelope2D used for the query. \param tolerance The
     ...
     * query The Envelope2D used for the query. \param tolerance The tolerance used
     ...
     * QuadTree_iterator. \param query The Geometry used for the query. If the
     * Geometry is a Line segment, then the query will be the segment. Otherwise the
     * query will be the Envelope2D bounding the Geometry. \param tolerance The
    ...
    /**
     * Gets an iterator on the QuadTree using the input Envelope2D as the query. To
     * reuse the existing iterator on the same QuadTree but with a new query, use
     * the reset_iterator function on the QuadTree_iterator. \param query The
     * Envelope2D used for the query. \param tolerance The tolerance used for the
     * intersection tests.
     */
     ...
     * Geometry is a Line segment, then the query will be the segment. Otherwise the
     * query will be the Envelope2D bounding the Geometry. \param tolerance The
     * tolerance used for the intersection tests. \param bSorted Put true to iterate
     * the quad tree in the order of the Element_types.
     */
     ...
     * the reset_iterator function on the QuadTree_iterator. \param query The
     * Envelope2D used for the query. \param tolerance The tolerance used for the
     * intersection tests. \param bSorted Put true to iterate the quad tree in the
     * order of the Element_types.
     */
    ...
    /**
     * Gets an iterator on the QuadTree. \param bSorted Put true to iterate the quad
     * tree in the order of the Element_types.
     */
