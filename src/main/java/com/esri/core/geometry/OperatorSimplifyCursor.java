...
class OperatorSimplifyCursor extends GeometryCursor {
    ...
    OperatorSimplifyCursor(GeometryCursor geoms, SpatialReference spatialRef, boolean bForceSimplify,
    ...
    Geometry simplify(Geometry geometry) {
        ...
        return OperatorSimplifyLocalHelper.simplifyAsFeature(geometry, m_spatialReference, m_bForceSimplify,
                m_progressTracker);
    }
}
