...
final class StridedIndexTypeCollection implements Serializable {
    ...
    /*
     * private final static int m_realBlockSize = 2048;//if you change this, change
     * m_blockSize, m_blockPower, m_blockMask, and st_sizes private final static int
     * m_blockMask = 0x7FF; private final static int m_blockPower = 11; private
    ...
    private final static int[] st_sizes = {16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384};
