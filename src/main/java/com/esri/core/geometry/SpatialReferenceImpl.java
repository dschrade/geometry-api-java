...
class SpatialReferenceImpl extends SpatialReference {
    ...
    static double geodesicDistanceOnWGS84Impl(Point ptFrom, Point ptTo) {
        ...
        double rpu = StrictMath.PI / 180.0;
        PeDouble answer = new PeDouble();
        GeoDist.geodesic_distance_ngs(a, e2, ptFrom.getX() * rpu, ptFrom.getY() * rpu, ptTo.getX() * rpu,
                ptTo.getY() * rpu, answer, null, null);
        return answer.val;
    }
    ...
    private static final int[] m_esri_codes = {2181, // ED_1950_Turkey_9
