...
/**
 * Performs the Relation operation between two geometries using the DE-9IM
 * matrix encoded as a string.
 *
 */
public abstract class OperatorRelate extends Operator {
     ...
     */
    public abstract boolean execute(Geometry inputGeom1, Geometry inputGeom2, SpatialReference sr, String de_9im_string,
            ProgressTracker progressTracker);

    public static OperatorRelate local() {
        return (OperatorRelate) OperatorFactoryLocal.getInstance().getOperator(Type.Relate);
    }
