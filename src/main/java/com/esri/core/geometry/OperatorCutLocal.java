...
class OperatorCutLocal extends OperatorCut {
    ...
    public static class CutPair {
        public CutPair(Geometry geometry, int side, int ipartCuttee, int ivertexCuttee, double scalarCuttee,
                int sidePrev, int ipartCutteePrev, int ivertexCutteePrev, double scalarCutteePrev, int ipartCutter,
                int ivertexCutter, double scalarCutter, int ipartCutterPrev, int ivertexCutterPrev,
    ...
    @Override
    public GeometryCursor execute(boolean bConsiderTouch, Geometry cuttee, Polyline cutter,
            SpatialReference spatialReference, ProgressTracker progressTracker) {
        return new OperatorCutCursor(bConsiderTouch, cuttee, cutter, spatialReference, progressTracker);
    }
}
