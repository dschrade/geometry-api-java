...
public abstract class OperatorImportFromWkb extends Operator {
     ...
     */
    public abstract Geometry execute(int importFlags, Geometry.Type type, ByteBuffer wkbBuffer,
     ...
     */
    public abstract OGCStructure executeOGC(int importFlags, ByteBuffer wkbBuffer, ProgressTracker progress_tracker);
