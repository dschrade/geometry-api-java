...
public class SegmentIterator {
    ...
    /**
     * Resets the iterator such that a subsequent call to PreviousPath will set the
     * iterator to the last path.
     */
     ...
     * path.
     * 
     * @return TRUE if the iterator points to the first segment in the current path.
     */
     ...
     * path.
     * 
     * @return TRUE if the iterator points to the last segment in the current path.
     */
    ...
    /**
     * Resets the iterator to a specific vertex. The call to next_segment will
     * return the segment that starts at the vertex. Call to previous_segment will
     * return the segment that starts at the previous vertex.
     * 
     * @param vertexIndex
