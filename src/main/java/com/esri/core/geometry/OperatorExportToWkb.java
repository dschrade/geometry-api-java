...
public abstract class OperatorExportToWkb extends Operator {
     ...
     * 
     * @param exportFlags
     *            Use the {@link WkbExportFlags} interface.
     * @param geometry
     *            The Geometry being exported.
     ...
     *            The Geometry being exported.
     * @param wkbBuffer
     *            The ByteBuffer to contain the exported Geometry in WKB format.
     * @return If the input buffer is null, then the size needed for the buffer is
     *         returned. Otherwise the number of bytes written to the buffer is
     *         returned.
     */
    public abstract int execute(int exportFlags, Geometry geometry, ByteBuffer wkbBuffer,
