...
public class Point extends Geometry implements Serializable {
    ...
    /**
     * Creates a 2D Point with specified X and Y coordinates. In case of Geographic
     * Coordinate Systems, the X coordinate is the longitude and the Y is the
     * latitude.
     * 
     * @param x
     ...
     * Geographic Coordinate Systems, the X coordinate is the longitude and the Y is
     * the latitude.
     * 
     * @param x
    ...
    /**
     * Sets the XY coordinates of this point. param pt The point to create the X and
     * Y coordinate from.
     */
    ...
    public void setAttribute(int semantics, int ordinate, double value) {
        ...
        m_attributes[m_description._getPointAttributeOffset(attributeIndex) - 2 + ordinate] = value;
    }
