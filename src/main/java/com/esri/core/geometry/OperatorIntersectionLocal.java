...
class OperatorIntersectionLocal extends OperatorIntersection {
    ...
    @Override
    public GeometryCursor execute(GeometryCursor inputGeometries, GeometryCursor intersector, SpatialReference sr,
    ...
    @Override
    public GeometryCursor execute(GeometryCursor input_geometries, GeometryCursor intersector, SpatialReference sr,
    ...
    @Override
    public Geometry execute(Geometry inputGeometry, Geometry intersector, SpatialReference sr,
            ProgressTracker progressTracker) {
        ...
        GeometryCursor geometryCursor = execute(inputGeomCurs, intersectorCurs, sr, progressTracker);
    ...
    public boolean accelerateGeometry(Geometry geometry, SpatialReference spatialReference,
        ...
        accelerated |= ((MultiVertexGeometryImpl) geometry._getImpl())._buildRasterizedGeometryAccelerator(tol,
                accelDegree);
        return accelerated;
    }
