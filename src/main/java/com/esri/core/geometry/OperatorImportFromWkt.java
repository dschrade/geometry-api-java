...
public abstract class OperatorImportFromWkt extends Operator {
     ...
     */
    public abstract Geometry execute(int import_flags, Geometry.Type type, String wkt_string,
    ...
    public static OperatorImportFromWkt local() {
        return (OperatorImportFromWkt) OperatorFactoryLocal.getInstance().getOperator(Type.ImportFromWkt);
    }
