...
class StringUtils {
    ...
    static void appendDouble(double value, int precision, StringBuilder stringBuilder) {
        if (precision < 0) {
            precision = 0;
    ...
    static void appendDoubleF(double value, int decimals, StringBuilder stringBuilder) {
        if (decimals < 0) {
            decimals = 0;
        } else if (decimals > 17) {
            decimals = 17;
