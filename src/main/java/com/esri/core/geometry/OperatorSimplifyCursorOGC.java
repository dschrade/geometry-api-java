...
class OperatorSimplifyCursorOGC extends GeometryCursor {
    ...
    OperatorSimplifyCursorOGC(GeometryCursor geoms, SpatialReference spatialRef, boolean bForceSimplify,
    ...
    Geometry simplify(Geometry geometry) {
        ...
        return OperatorSimplifyLocalHelper.simplifyOGC(geometry, m_spatialReference, m_bForceSimplify,
                m_progressTracker);
    }
}
